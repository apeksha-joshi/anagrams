...
public class AnagramDictionary {
    ...
    public String pickGoodStarterWord() {
        ...
        boolean goOn = true;
        while (goOn) {
            //num = random.nextInt(9000)+1;- only one number
           // num = (int)(Math.random()*62995+1);  // Repeats same set of numbers
            //num = random.nextInt((62995-1)+1)+1;-not working
            num = (int)(Math.random()*((62995-1)+1));  //Repeats same set of numbers
